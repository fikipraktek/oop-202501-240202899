...
public class MainCart {
    public static void main(String[] args) {
        System.out.println("Hello, I am FIKI ANTO-240202899 (Week7)");
        ShoppingCart cart = new ShoppingCart();

        Product p1 = new Product("P01", "Pupuk", 5000, 10);
        Product p2 = new Product("P02", "Benih Jagung", 3000, 20);
...
public class MainCartMap {
    public static void main(String[] args) {
        ...
        Product p2 = new Product("P02", "Pupuk", 30000,15);
        Product p3 = new Product("P03", "Insektisida", 150000,5);
...
### Menggunakan ArrayList
![Screenshot hasil](screenshots/gambar_1.png)

### Menggunakan Map
![Screenshot hasil](screenshots/gambar_2.png)
